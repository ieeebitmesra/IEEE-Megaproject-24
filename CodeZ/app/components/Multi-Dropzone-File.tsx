...
const variants = {
  base: 'relative rounded-md p-4 w-full flex justify-center items-center flex-col cursor-pointer border-2 border-dashed border-gray-500 transition-colors duration-300 ease-in-out',
  active: 'border-2',
  disabled:
    'bg-gray-100 border-gray-300 cursor-default pointer-events-none bg-opacity-30 ',
          ...
          {value?.map(({ file, abortController, progress }, i) => (
            ...
            >
              <div className="flex items-center gap-2 text-gray-500 ">
                <FileIcon size="30" className="shrink-0 text-gray-700" />
                <div className="min-w-0 text-sm">
                  <div className="overflow-hidden overflow-ellipsis whitespace-nowrap text-gray-700">
                    {file.name}
                  </div>
                ...
                <div className="flex w-12 justify-end text-xs">
                  {progress === 'PENDING' ? (
                    ...
                    >
                      <Trash2Icon className="shrink-0 text-gray-700" />
                    </button>
                  ) : progress === 'ERROR' ? (
              ...
              {typeof progress === 'number' && (
                <div className="relative h-0">
                  <div className="absolute top-1 h-1 w-full overflow-clip rounded-full bg-white">
                    <div
