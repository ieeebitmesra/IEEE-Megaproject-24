...
export default {
  ...
  SIGNIN_SUBHEADING: 'To use QuickCode you must log into an existing account or create one.',
  SIGNIn_AGREEMENT_TEXT: 'By using QuickCode, you agree to the collection of usage data for analytics.',
